...
public class ConsulterSanctions {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ConsulterSanctions window = new ConsulterSanctions();
	 ...
	 */
	public ConsulterSanctions() {
		initialize();
	}
	
	public ConsulterSanctions(int idEtudiant) {
		initialize();
	}
	...
	private void initialize() {
		 ...
		 */
		ArrayList<Sanction> liste = sanctionDAO.getList(idEtudiant);
		...
		JLabel lblNewLabel = new JLabel("CONSULTER SANCTIONS");
